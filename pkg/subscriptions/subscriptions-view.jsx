...
define([
    "base1/cockpit",
    "subscriptions/react",
    "subscriptions/cockpit-components-listing",
], function(cockpit, React, cockpitListing) {
...
var SubscriptionsPage = React.createClass({
    render: function() {
        ...
        if (this.props.status === undefined ||
            this.props.status == 'not-found' || this.props.status == 'access-denied') {
            var icon;
            var description;
            var message;
            if (this.props.status === undefined) {
