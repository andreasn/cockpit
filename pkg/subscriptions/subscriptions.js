...
require([
    ...
    "subscriptions/subscriptions-register",
    "subscriptions/subscriptions-view",
    "subscriptions/cockpit-components-dialog",
], function(cockpit, React, subscriptionsClient, subscriptionsRegister, subscriptionsView, Dialog) {
...
function initStore(rootElement) {
    ...
    subscriptionsClient.init(dataChanged);

    dataStore.render = function() {
        React.render(React.createElement(subscriptionsView.page, {
